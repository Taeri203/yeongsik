...
export const metadata: Metadata = {
  title: "유천동 공약",
  description: "유천네거리, 대단지 생활민원, 유천초·한솔초 통학권, 진천천 중심의 유천동 생활공약입니다.",
};

const district = districts.find((item) => item.slug === "yucheon")!;

export default function YucheonPage() {
  return (
    <>
      ...
      <section className="pb-16">
        <div className="container-page">
          <CTASection title="유천동 불편을 알려주세요" description="커지는 생활권의 불편을 더 촘촘하게 모으겠습니다." buttonLabel="민원 남기기" href="/voice" tone="yellow" />
        </div>
      </section>
    </>
  );
